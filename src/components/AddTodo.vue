<template>
    <div class="flex flex-wrap px-12">
        <h3 class="w-full py-10 text-3xl text-white font-bold">Add Todo</h3>

        <form method="POST" @submit.prevent="store" class="flex flex-wrap w-full">
            <div class="flex flex-wrap w-full bg-white rounded-lg">
                ...
                <div class="lg:w-1/5 w-full">
                    <button class="w-full h-full py-3 px-6 bg-green-300  focus:outline-none hover:bg-green-800 hover:text-white lg:rounded-r-lg">Add</button>
                </div>
